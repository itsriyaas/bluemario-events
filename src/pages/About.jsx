...
function About() {
  return (
    ...
    <Helmet>
        ...
        <meta
          name="description"
          content="Blue Mario Events is a top event planner in Thrissur, providing expert wedding planning,  and comprehensive event management services in thrissur"
        />
